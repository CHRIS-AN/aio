        ...
        <div class="right_col" role="main">
            ...
            <form action="insertProduct" method="post">
                <table class="table table-bordered" style="width: 50%; margin: auto;">
                    ...
                    <tr>
                        <td>* 단위</td>
                        <td><input type="text" name="prod_bundle" value="${product.prod_bundle}"/> (숫자로 10자이하)<p style="border-style: none; color: red;">${valid_prod_bundle}</p></td>
                    </tr>
                    <tr>
                        <td>* 판매가</td>
                        <td><input type="text" name="sell_price" value="${product.sell_price}"/> (숫자로 10자 이하)<p style="border-style: none; color: red;">${valid_sell_price}</p></td>
                    </tr>
                    <tr>
                        <td>* 구매가</td>
                        <td><input type="text" name="buy_price" value="${product.buy_price}"/> (숫자로 10자 이하)<p style="border-style: none; color: red;">${valid_buy_price}</p></td>
                    </tr>
                    <tr>
                        <td>* 카테고리</td>
