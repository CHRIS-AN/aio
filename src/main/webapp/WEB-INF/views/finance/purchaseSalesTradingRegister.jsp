...
<div class="container mt-5">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-7 mb-5">
            <form class="needs-validation" action="/finance/purchaseSalesTradingRegister" method="post">
                ...
                <div class="container ">
                    ...
                    <button type="submit" class="btn btn-outline-info mt-5" style="" onclick="registerClick()">전표 등록</button>
                </div>
            </form>
        </div>
    </div>
