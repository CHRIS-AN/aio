...
.nav.side-menu>li.active>a {
    ...
    background: linear-gradient(#372C81, #382c84), #2A3F54;
    box-shadow: rgba(255, 255, 255, 0.16) 0 1px 0px, inset rgba(255, 255, 255, 0.16) 0 1px 0px;
}
.navbar-brand,
.navbar-nav>li>a {
    font-weight: 500;
